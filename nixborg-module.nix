  ...
  in mkMerge [
    ...
    (mkIf cfg.receiver.enable {
      ...
      systemd.services.nixborg-receiver = {
        ...
        wantedBy = [ "multi-user.target" ];
        path = [
          # FIXME remove override after https://github.com/NixOS/hydra/pull/516
          (pkgs.hydra.overrideAttrs (old: {
        ...
        serviceConfig = {
          ...
          Group = "hydra";
          ExecStart = "${pkg.receiver}/bin/nixborg-receiver";
          Restart = "always";
        };
      };
    })
